    ...
    def _check_quantity_names(self,
        ...
        for name in names:
            ...
            if not re.match(r'[0-9a-z][0-9a-z\-_]*', name):
                raise commands.UserInputError(f"Quantity name {name!r} is invalid; quantity names and aliases may only contain lowercase letters, numbers, hyphens, or underscores, and must begin with a lowercase letter or number")
